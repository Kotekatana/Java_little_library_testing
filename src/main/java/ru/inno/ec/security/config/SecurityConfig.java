...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, PersistentTokenRepository tokenRepository) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests().antMatchers("/books/**").authenticated();
        httpSecurity.authorizeHttpRequests().antMatchers("/authors/**").authenticated();
        httpSecurity.authorizeHttpRequests().antMatchers("/genres/**").authenticated();
        httpSecurity.authorizeHttpRequests().antMatchers("/users/**").hasAuthority("ADMIN");
        httpSecurity.authorizeHttpRequests().antMatchers("/orders/**").hasAuthority("ADMIN");
